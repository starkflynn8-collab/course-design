...
INSERT INTO `currentuser` VALUES (58, 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMjMuY29tIiwiZXhwIjoxNzY3ODAwNjA3OTAzLCJpYXQiOjE3NjY5MzY2MDc5MDN9.K9VUEcUCrEBaqnkKe6hGL0oL3nUZw8vfJKDM-bYLa5U');
...
CREATE TABLE `goods`  (
  ...
  `gContact` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商家联系方式',
  `college` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '一级分类：学院/学科',
  `subject` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '二级分类：专业课/通识课程',
  `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '书籍类型：教材/参考书/考研书',
  `campus` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '校区：九龙湖/四牌楼/丁家桥等',
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (107, '线性代数', 1, '湖区自提', 20.00, 58, '/upload/1766923654409_6991.jpg', 4, '15852869088', '工学', '通识基础课', '教材', '九龙湖');
INSERT INTO `goods` VALUES (109, '计算机组成原理', 1, '', 25.00, 58, '/upload/1766924450975_518.jpg', 4, '15852869088', '工学', '专业课', '教材', '九龙湖');
INSERT INTO `goods` VALUES (110, '数据结构', 1, '', 25.00, 58, '/upload/1766924526852_3105.jpg', 5, 'QQ：3866826537', '工学', '专业课', '教材', '九龙湖');
INSERT INTO `goods` VALUES (111, '量子物理', 0, '', 12.00, 58, '/upload/1766934986119_1230.jpg', 2, '15852869088', '理学', '专业课', '教材', '九龙湖');
INSERT INTO `goods` VALUES (113, '数学物理方法', 2, '', 12.00, 58, '/upload/1766941116315_5191.jpg', 4, '18952533360', '工学', '专业课', '教材', '九龙湖');
...
INSERT INTO `order` VALUES (350, 1, '2025-12-17 19:09:16', 399.99, 1, 4, 58, 12);
INSERT INTO `order` VALUES (351, 1, '2025-12-17 21:30:53', 5.00, 1, 58, 59, 89);
INSERT INTO `order` VALUES (352, 1, '2025-12-17 22:36:28', 25.00, 1, 58, 58, 90);
INSERT INTO `order` VALUES (353, 1, '2025-12-19 14:23:41', 25.00, 1, 58, 58, 102);
INSERT INTO `order` VALUES (354, 1, '2025-12-28 23:31:54', 25.00, 1, 58, 59, 112);
INSERT INTO `order` VALUES (355, 1, '2025-12-29 01:01:25', 12.00, 1, 58, 58, 111);
...
INSERT INTO `profit` VALUES (354, 0.25);
INSERT INTO `profit` VALUES (355, 0.12);
INSERT INTO `profit` VALUES (353, 0.25);
INSERT INTO `profit` VALUES (352, 0.25);
INSERT INTO `profit` VALUES (350, 4.00);
